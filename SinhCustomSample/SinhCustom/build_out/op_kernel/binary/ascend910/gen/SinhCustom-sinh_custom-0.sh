...
opc $1 --main_func=sinh_custom --input_param=/tmp/code/SinhCustomSample/SinhCustom/build_out/op_kernel/binary/ascend910/gen/SinhCustom_01ec8ddcf6437b12e69898b368caea08_param.json --soc_version=Ascend910A --output=$2 --impl_mode="" --simplified_key_mode=0 --op_mode=dynamic
