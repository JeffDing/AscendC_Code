...
@tbe_register.register_operator("SinhCustom", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_OUTPUT, para_check.KERNEL_NAME)
def sinh_custom(x_in__, z_out_, kernel_name="sinh_custom", impl_mode=""):
    ...
    ascendc_src_dir_ex = "sinh_custom"
    ...
    print("start compile Ascend C operator SinhCustom. kernel name is " + kernel_name)
    op_type = "SinhCustom"
